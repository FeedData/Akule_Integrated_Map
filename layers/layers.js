...
ol.proj.get("EPSG:32736").setExtent([34442.324325, 8083144.025446, 1212885.137965, 9000733.612108]);
var wms_layers = [];
...
lyr_Malawi_Districts_1.set('fieldAliases', {'DISTRICT': 'DISTRICT', 'COUNT': 'COUNT', 'AREA_SQ_M': 'AREA_SQ_M', 'AREA': 'AREA', 'PERIMETER': 'PERIMETER', 'HECTARES': 'HECTARES', 'REGION': 'REGION', 'CBCCs': 'CBCCs', 'FRDP': 'FRDP', });
lyr_Akule_FEED_Districts_2.set('fieldAliases', {'id': 'id', 'Dist_Code': 'Dist_Code', 'DISTRICT': 'DISTRICT', 'AREA_SQ_M': 'AREA_SQ_M', 'AREA': 'AREA', 'HECTARES': 'HECTARES', 'REGION': 'REGION', 'CBCCs': 'CBCCs',});
...
lyr_Akule_FEED_Districts_2.set('fieldImages', {'id': 'Hidden', 'Dist_Code': 'Hidden', 'DISTRICT': 'TextEdit', 'CBCCs': 'TextEdit', 'AREA_SQ_M': 'Hidden', 'AREA': 'Hidden', 'HECTARES': 'Hidden', 'REGION': 'TextEdit', });
...
lyr_Malawi_Districts_1.set('fieldLabels', {'DISTRICT': 'inline label', 'REGION': 'inline label', 'CBCCs': 'inline label',});
lyr_Akule_FEED_Districts_2.set('fieldLabels', {'DISTRICT': 'inline label', 'REGION': 'inline label', 'CBCCs': 'inline label',});
